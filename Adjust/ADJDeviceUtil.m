...
+ (BOOL)adjTrackingEnabled {
    ...
    NSString *className = [ADJStringUtil adjJoin:@"A", @"S", @"identifier", @"manager", nil];
...
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
    ...
    NSString *keyManager = [ADJStringUtil adjJoin:@"shared", @"manager", nil];
    ...
    NSString *keyEnabled = [ADJStringUtil adjJoin:@"is", @"advertising", @"tracking", @"enabled", nil];
...
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
    ...
    NSString *keyIdentifier = [ADJStringUtil adjJoin:@"advertising", @"identifier", nil];
    ...
    NSString *keyString = [ADJStringUtil adjJoin:@"UUID", @"string", nil];
